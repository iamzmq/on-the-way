...
(slide (v 
        (t "Hi Guys,") 
        (t "This is still a difficult approach to adopt.")
(t "To be honest we are asking Jenkins to try and do what Tableaux does (see below) and I still don’t understand why.
...
(slide #:name "food"
       ...
       (bitmap "consultant_journey/see-food.jpg"))
